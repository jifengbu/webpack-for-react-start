            ...
            <FormItem
                ...
                >
                {
                    editing && form.getFieldDecorator(key, {
                        ...
                        <InputNumber {...otherProps} precision={2} min={min} max={max} step={step} />
                    ) || (
                ...
                <span className={styles.unit} style={{ marginRight: unit === '元' ? 40 : 24 }}>{unit}</span>
                {
                    editing && (
                        ...
                        <span>
                            <span>保底价：</span>
                            <InputNumber value={base} precision={2} min={min} max={max} step={step} onChange={::this.handleBaseChange} />
                        </span>
                        ||
