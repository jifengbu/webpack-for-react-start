                ...
                <Col span='4'>
                    {
                        ...
                        <FormItem label='' hasFeedback>
                            <InputNumber value={size.length} precision={2} min={scopes[0].min} max={scopes[0].max} step={scopes[0].step} onChange={this.handleChange.bind(this, 'length')} />
                        </FormItem>
                        ||
                ...
                <Col span='4'>
                    {
                        editing &&
                        <FormItem label='' hasFeedback>
                            <InputNumber value={size.width} precision={2} min={scopes.length > 1 ? scopes[1].min : scopes[0].min} max={scopes.length > 1 ? scopes[1].max : scopes[0].max} step={scopes.length > 1 ? scopes[1].step : scopes[0].step} onChange={this.handleChange.bind(this, 'width')} />
                        </FormItem>
                        ||
                ...
                <Col span='4'>
                    {
                        editing &&
                        <FormItem label='' hasFeedback>
                            <InputNumber value={size.height} precision={2} min={scopes.length > 2 ? scopes[2].min : scopes[0].min} max={scopes.length > 2 ? scopes[2].max : scopes[0].max} step={scopes.length > 2 ? scopes[2].step : scopes[0].step} onChange={this.handleChange.bind(this, 'height')} />
                        </FormItem>
                        ||
